 ...
 */
namespace SixtySeven\UploadVideo\Model\Product\Attribute\Media;
...
/**
 * Converter for External Uploaded Video media gallery type
 */
class ExternalVideoEntryConverter extends ImageEntryConverter
{
     ...
     */
    const MEDIA_TYPE_CODE = 'external-uploaded-video';
