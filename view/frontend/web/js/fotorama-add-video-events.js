    ...
    $.widget('mage.AddFotoramaVideoEvents', {
        ...
        _createVideoData: function (inputData, isJSON) {
            ...
            for (i = 0; i < inputData.length; i++) {
                ...
                if (tmpInputData.mediaType !== 'external-video' && tmpInputData.mediaType !== 'external-uploaded-video') {
        ...
        _checkForVideoExist: function () {
            ...
            for (key in result) {
                if (result[key].mediaType === this.VID || result[key].mediaType === 'external-uploaded-video') {
                    checker = true;
                }
            }
        ...
        _isVideoBase: function () {
            ...
            for (i = 0; i < allVideoDataKeys.length; i++) {
                ...
                if (
                    (videoItem.mediaType === this.VID || videoItem.mediaType === 'external-uploaded-video') && videoItem.isBase &&
        ...
        _setThumbsIcon: function (elem, i) {
            ...
            if ((this.options.videoData[i].mediaType === this.VID || this.options.videoData[i].mediaType === 'external-uploaded-video' )&&
                (fotorama.data[i].type ===  this.VID || fotorama.data[i].type === 'uploaded-video') &&
        ...
        _checkForVideo: function (e, fotorama, number) {
            ...
            if ($image && videoData && (videoData.mediaType === this.VID || videoData.mediaType === 'external-uploaded-video')) {
